          ...
          <div className="flex justify-end">
            ...
            >
              ...
              >
                ...
                293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.4147"                
                clipRule = "evenodd"
                />
                  ...
                  <div className="relative mt-3" >
                    ...
                    <div className="relative mt-3" >
                      ...
                      <div className="relative mt-3">
                        ...
                        <button 
                        onClick={() => createItem()}
                        className="block w-full mt-3 py-3 px-4 font-medium text-sm text-center text-white bg-indigo-600 hover:bg-indigo-500 
                        active:bg-indigo-700 rounded-lg ring-offset-2 ring-indigo-600 focus:ring-2"
                        >
                          Create Shipment
                        </button>
                        </form>
